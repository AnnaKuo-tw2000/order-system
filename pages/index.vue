...
<template>
    <div class="bg-[url('/img/bg-1.jpg')] ">
        <section id="titleSection"
            class=" py-12 px-20 text-amber-950 flex justify-between items-center max-[1170px]:flex-col gap-10">
            ...
            <div id="rightContent" class="w-1/2 fadeInRight max-[1170px]:w-[400px]">
        ...
        <section class=" p-8 text-amber-950 mb-[3%]">
            ...
            <div class="flex flex-row justify-evenly ">
                <div class="w-1/3 flex flex-col items-center gap-2 px-2.5 py-2.5">
                    ...
                    <div class="text-2xl font-medium max-md:text-xl">台灣本土蔬菜</div>
                    <p class="text-lg max-md:text-base">
                        本店嚴選最新鮮的當季蔬菜，來自當地優質農田。每道料理都注重新鮮風味，以保留蔬菜的天然美味。我們致力於提供新鮮、營養豐富的蔬食饗宴，為您呈現最令人垂涎的美食體驗。</p>
                </div>
                <div class="w-1/3 flex flex-col items-center gap-2 px-2.5 py-2.5">
                    <div class="">
                        <img src="../img/feature-2.png" alt="" class="rounded-full ">
                    </div>
                    <div class="text-2xl font-medium max-md:text-xl">專業米其林廚師</div>
                    <p class="text-lg max-md:text-base">
                ...
                <div class="w-1/3 flex flex-col items-center gap-2 px-2.5 py-2.5">
                    ...
                    <div class="text-2xl font-medium max-md:text-xl">對於專業不能退讓</div>
                    <p class="text-lg max-md:text-base">
        ...
        <section class="bg-amber-950 text-white flex justify-center gap-[5%] px-12 max-md:px-6 mb-[3%]">
            ...
            <div class="w-[500px] flex flex-col justify-center gap-3 ">
                <h1 class="text-2xl max-md:text-xl">創始主廚：帕金森，梅再帕</h1>
                <p class="text-lg max-md:text-base">today chef:plum in shock</p>
        ...
        <section id="popularSection"
            class="bg-[url('/img/bg-4.jpg')] h-[90vh] bg-center bg-cover relative max-[1170px]:h-[70vh] ">
            <div class="w-full h-full bg-black opacity-40 text-white p-4 absolute"></div>
            <div id="menuContent" class=" text-white absolute top-[10%] max-md:top-[15%]">
